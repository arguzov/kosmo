ActiveAdmin.register Service do
  ...
  permit_params :name, :anounce, :photo, :content, :price, :title, :description, :keys, :complements, :fl_show, :fl_publish, :pricelist,:parent_id,:url, :is_structured, :fl_order, :metrika_id, expert_ids: [], filial_ids: [], block_ids: []
