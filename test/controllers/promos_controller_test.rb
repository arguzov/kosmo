...
class PromosControllerTest < ActionController::TestCase
  ...
  test "should create promo" do
    assert_difference('Promo.count') do
      post :create, promo: { banner: @promo.banner, content: @promo.content, due: @promo.due, fl_active: @promo.fl_active, fl_top: @promo.fl_top, name: @promo.name }
    end
  ...
  test "should update promo" do
    patch :update, id: @promo, promo: { banner: @promo.banner, content: @promo.content, due: @promo.due, fl_active: @promo.fl_active, fl_top: @promo.fl_top, name: @promo.name }
    assert_redirected_to promo_path(assigns(:promo))
  end
